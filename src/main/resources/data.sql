...
VALUES('Phone XL', 799, 'A large phone with one of the best screens');
INSERT INTO product(name, price, description)
VALUES('Phone Mini', 699, 'A great phone with one of the best cameras');
INSERT INTO product(name, price, description)
VALUES('Phone Standard', 299, '');